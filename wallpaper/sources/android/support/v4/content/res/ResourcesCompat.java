...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r21, android.content.res.Resources r22, android.util.TypedValue r23, int r24, int r25, @android.support.annotation.Nullable android.support.v4.content.res.ResourcesCompat.FontCallback r26, @android.support.annotation.Nullable android.os.Handler r27, boolean r28) {
        ...
        L_0x0062:
            ...
            r6 = r1
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = android.support.v4.content.res.FontResourcesParserCompat.parse(r6, r9)     // Catch:{ XmlPullParserException -> 0x00bf, IOException -> 0x00b8 }
            r17 = r1
        ...
        L_0x009b:
            ...
            r10 = -3
            r8 = r28
            android.graphics.Typeface r1 = android.support.v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x00b4, IOException -> 0x00b0 }
            return r1
        L_0x00b0:
            r0 = move-exception
            r1 = r21
        ...
        L_0x00c6:
            ...
            r10 = -3
            r1 = r21
            android.graphics.Typeface r2 = android.support.v4.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r9, r11, r15, r12)     // Catch:{ XmlPullParserException -> 0x00e9, IOException -> 0x00e6 }
            r7 = r2
